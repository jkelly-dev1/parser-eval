...
Why Opus 5 and not sonnet. The pair is price-matched on purpose: claude-opus-5
at $5/$25 per million tokens against gpt-5.6-sol at $5/$30: identical input
price, 20% apart on output. Running a cheaper model on one side and the
flagship on the other would make the cost column meaningless. Sonnet 5 is the
interesting third run and it is not this one. The prices, and the date they
were verified, are in cloud_cost.py.

...
WHY pdftotext rather than a library. This extracts the layer with as little
interpretation as possible, from a tool with no stake in the comparison.
-layout preserves the column positions the page was printed with, which is
the most generous reading of a table's text layer.
"""
